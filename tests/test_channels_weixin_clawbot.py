...
def test_parse_text_update_message():
    from deepclaw.web_backend.channels.adapters.weixin_clawbot import WeixinClawBotAdapter
...
def test_send_message_posts_ilink_payload():
    from deepclaw.web_backend.channels.adapters.weixin_clawbot import WeixinClawBotClient
