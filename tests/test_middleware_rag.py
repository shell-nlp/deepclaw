...
class DummyVectorStore:
    ...
    def retrieve(self, *, query, k, index_name):
        self.calls.append({"query": query, "k": k, "index_name": index_name})
        return [
            {
...
def test_graph_retrieve_falls_back_to_normal_retrieve_for_non_es_store():
    ...
    assert store.calls == [{"query": "hello", "k": 2, "index_name": "kb_demo_passages"}]
